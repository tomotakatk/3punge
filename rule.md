...
|事象|期日|
|---------|---------|
|事前抽選A 応募開始|2015年8月29日(土)|
|事前抽選A 応募終了|2015年9月1日(火)23時59分|
|事前抽選A 当落発表|2015年9月2日(水)|
|事前抽選B 応募開始|2015年9月2日(水)|
|事前抽選B 応募終了|2015年9月8日(火)23時59分|
|事前抽選B 当落発表|2015年9月9日(水)|
...
6. 応募作品は半永久的に3分ゲーコンテストのウェブサイト上に公開される事とする。
7. 過去にインターネット・雑誌・イベント等で第三者に公開された事のある作品を応募する事はできない。
8. コンテスト終了(順位の速報公開)まで、応募作品を本コンテストウェブサイト以外の場所で公開してはならない。
9. 応募は各回に一人1作品までとする。
10. 応募後、本コンテストを棄権する場合は、一般審査開始前に申し出ること。
11. 応募した作品の修正は可能。ZIPファイルの差し替えが必要な場合は、運営にメールで連絡する。
12. 審査期間中に応募作品を修正した場合、修正項目を「3分ゲーコンテスト公式サイト アップデート情報掲示板」にて告知する。
13. 応募締め切り日までに正常に動作する作品を応募しなければならない。ゲームプレイを続行するのに不可能な重大なバグや不都合のある作品は棄権とする。
14. 作品の受付は次回コンテストの締切1週間前から開始される。
15. 応募作品の総容量は、圧縮の状態で20メガバイト以下にすること。
16. 20メガバイトを超える場合は応募前にあらかじめ主催者に連絡を入れ、許可を取ること。
17. 作品応募時、応募フォームより以下の情報を明記すること。
	* 作者のハンドルネーム
	* 作者の連絡先
	* ウェブサイトのアドレス
	* 作品名
